...
if submit:
    ...
    has_loan_values = [1 if lt in type_of_loan else 0 for lt in loan_types]
    ...
    features = [
        ...
        outstanding_debt, credit_utilization_ratio, ch_months, total_emi_per_month,
        amount_invested_monthly, monthly_balance, occupation, payment_of_min_amount,
